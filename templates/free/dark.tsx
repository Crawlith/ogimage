...
const schema = {
  title: { type: 'string', required: true, maxLength: 100, default: 'Building the Future' },
  subtitle: { type: 'string', required: false, maxLength: 200, default: 'Systems are green, all monitors active.' },
  author: { type: 'string', required: false, default: 'admin@og-engine' },
  context: { type: 'string', required: false, default: 'ROOT_ACCESS' },
  tag: { type: 'string', required: false, default: 'ACTIVE' },
